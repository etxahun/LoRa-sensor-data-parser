...
if __name__ == '__main__':
    ...
    while True:
        ...
        data_complete_hex = "\x0a" + data_hex + "\xdd\xff\xff\x20\x00\x20"
        # data_complete_hex = "0a" + data_hex
        print(data_complete_hex)

        data_complete_coded = base64.b64encode(data_complete_hex)
        print(data_complete_coded)
        lora_message['data'] = data_complete_coded

        (rc, mid) = client.publish(conf["sim_topic"], str(lora_message), conf["qos_pub"], conf["rf"])
